...
public class UserDaoService {
    ...
    static {
        users.add(new User(1, "Jeong", new Date(), "test1", "701010-1111111"));
        users.add(new User(2, "Seong", new Date(), "test2", "801111-2222222"));
        users.add(new User(3, "Gil", new Date(), "test3", "901313-1111111"));
    }
